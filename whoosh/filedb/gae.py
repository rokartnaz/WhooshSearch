...
To create a new index::
    ...
    from WhooshSearch.whoosh.filedb.gae import DatastoreStorage
...
from WhooshSearch.whoosh.compat import BytesIO
from WhooshSearch.whoosh.index import TOC, FileIndex, _DEF_INDEX_NAME
from WhooshSearch.whoosh.filedb.filestore import ReadOnlyError, Storage
